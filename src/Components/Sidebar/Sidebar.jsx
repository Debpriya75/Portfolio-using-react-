...
import ProfilePhoto from "../../assets/Debpriya.gif";
...
const Brand = () => (
  <div className="flex md:items-baseline">
    <h1 className="text-white text-3xl md:text-5xl font-semibold md:font-bold">
      Debpriya
    </h1>
        ...
        <ul className="flex flex-col justify-center">
          {links.map((temp, index) => (
            <li
              ...
              onMouseLeave={() => stop()}
            >
              <Links Link={temp.link} Icon={temp.icon} Url={temp.url}></Links>
            </li>
          ))}
        </ul>
        <Copyright />
